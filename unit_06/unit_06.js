...
const f3 = () => {
  a3.forEach((el, ind) => (el > 4 ? z3.push(ind) : 0))
  console.log(z3)
}
...
const f4 = () => {
  z4 = a4.filter((el) => typeof el !== 'number')
  console.log(z4)
}
...
const f6 = () => {
  z6 = a6.filter((el) => el.reduce((acc, el) => acc + el, 0) % 2 == 0)
  console.log(z6)
}
...
const f7 = () => {
  z7 = a7.filter((el) => el.pass.length <= 6)
  console.log(z7)
}
...
const f8 = () => {
  // проще форычом
  a8.forEach((el) => (el % 2 === 0 ? z8.push(el) : z8_2.push(el)))
  console.log(a8)
  console.log(z8)
  console.log(z8_2)
}
...
const f10 = () => {
  let obj = callback10(a10)
  z10 = obj.filter((el) => Math.abs(el[1]) > 5)
  console.log(Object.fromEntries(z10))
}
