...
const f1 = () => {
  document.querySelector('.out-1').innerText = a1.join()
}
...
const f2 = () => {
  document.querySelector('.out-2').innerText = a2.join('')
}
...
const f3 = () => {
  document.querySelector('.out-3').innerText = a3.join('=')
}
...
const f6 = () => {
  a6_res = s6.split('')
  document.querySelector('.out-6').innerHTML = JSON.stringify(a6_res)
}
...
const f10 = () => {
  a10_res = [...s10].filter((el) => el.charCodeAt() > 'l'.charCodeAt())
