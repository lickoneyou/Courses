...
const f2 = () => {
  ...
  console.log(
    a2.filter ? (out2.innerText = 'true') : (out2.innerText = 'false'),
  )
}
...
const f5 = () => {
  ...
  let res = a5.reduce((accum, item) => accum + item, 0)
  out5.innerText = res
}
...
const f6 = () => {
  ...
  let res = a6.reduce((accum, item) => accum * item, 1)
  out6.innerText = res
}
...
const f11 = () => {
  let res = a11.reduce((accum, item) => (accum > item ? accum : (accum = item)))
...
const f12 = () => {
  let res = a12.reduce((accum, item) => (accum > item ? accum : (accum = item)))
...
const f15 = () => {
  let res = a15.reduce((accum, item) => accum + item, 0) / a15.length
...
const f16 = () => {
  let res = a16.reduce((acc, el) => {
    acc[el.id] = el.name
    return acc
  }, {})

  document.querySelector('.out-16').innerHTML = JSON.stringify(res)
}
...
const f17 = () => {
  a17_res = Object.values(a17).join(' ')
...
const f18 = () => {
  ...
  document.querySelector('.out-18').innerHTML = JSON.stringify(res)
}
...
const f19 = () => {
  ...
  document.querySelector('.out-19').innerHTML = JSON.stringify(res)
}
...
const f20 = () => {
  document.querySelector('.out-20').innerHTML = a20.reverse()
}
