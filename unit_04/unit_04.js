...
function f4() {
  let cb = document.querySelector('.i-4')

  document.querySelector('.out-4').innerText = cb.checked
}
...
function f5() {
  let cb = document.querySelector('.i-5')

  document.querySelector('.out-5').innerText = cb.checked ? cb.value : false
}
...
function f6() {
  document.querySelector('.out-6').innerText = document.querySelector(
    '.i-6',
  ).value
}
...
function f7() {
  document.querySelector('.out-72').innerText =
    document.querySelector('.i-7').value.length >= 6 ? 1 : 0
}
...
function f81() {
  document.querySelector('.out-81').innerHTML = document.querySelector(
    '.i-81',
  ).value
}
...
function f9() {
  document.querySelector('.out-9').innerText = document.querySelector('.r-9')
    .checked
...
function f11() {
  document.querySelector('.i-112').value = document.querySelector(
    '.i-111',
  ).value
}
...
function f12() {
  document.querySelector('.out-12').innerText = document.querySelector(
    '.i-12',
  ).value
}
...
function f13() {
  document.querySelector('.out-13').innerText = document.querySelector(
    '.i-13',
  ).value
}
...
function f14() {
  document.querySelector('.out-14').innerText = document.querySelector(
    '.t-14',
  ).value
}
...
function f15() {
  document.querySelector('.out-15').innerText = document.querySelector(
    '.i-15',
  ).value
...
function f16() {
  ...
  document.querySelector('.out-16').innerText = document.querySelector(
    '.s-16',
  ).value
}
...
function f17() {
  document.querySelector('.out-17').innerText = document.querySelector(
    '.s-17',
  ).value
}
...
function f19() {
  let i1 = document.querySelector('.i-191').value
  let i2 = document.querySelector('.i-192').value
  document.querySelector('.out-19').innerText = `${i1} ${i2}`
}
...
function f20(e) {
  ...
  document.querySelector(
    '.out-20',
  ).innerText = `${form.elements['username'].value} ${form.elements['password'].value}`
}
