...
function f11() {
  ...
  document.querySelector('.out-11').textContent = d11.indexOf(i)
}
...
function f12() {
  ...
  document.querySelector('.out-12').textContent = d12.findIndex((el) => el == i)
}
...
function f14() {
  let i = +document.querySelector('.i-14').value
  d14 = Array(i).fill(1)
  showArr('.out-14', d14)
}
...
function f15() {
  let i = +document.querySelector('.i-15').value
  d15.includes(i) ? true : d15.push(i)
  showArr('.out-15', d15)
}
...
function f17() {
  d171.forEach((el) => d17.push(el))
  d172.forEach((el) => d17.push(el))
...
function f18() {
  ...
  document.querySelector('.out-18').textContent = d18.includes(i)
}
...
function f19() {
  d19.forEach((el) => (el.length > maxString.length ? (maxString = el) : false))
