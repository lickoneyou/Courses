...
function t2() {
  ...
  a1.forEach((el) => a2_res.push(el / 2))
...
function t3() {
  ...
  a3.forEach((el) => (typeof el == 'number' ? a3_res.push(el) : false))
...
function t4() {
  ...
  span.forEach((el) => a4_res.push(el.getAttribute('data')))
