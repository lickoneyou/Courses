...
let ar2 = [1, 2, 'three', true] // переменную обьявляем здесь!!!!
...
let ar3 = [1, 2, 'three', true] // переменную обьявляем здесь!!!!
...
function f4() {
  document.querySelector('.out-4').textContent = [ar4[0], ar4[3], ar4[8]].join(
    ' ',
  )
}
...
let ar6 = ['Kirill', 'vodoley', 12, 2]

function f6() {
  document.querySelector('.out-6').textContent = ar6.join(' ')
}
...
function f11() {
  ...
  ar11[2] = ar11[4]
  ar11[4] = a
  document.querySelector('.out-11').textContent = ar11.join(' ')
}
...
function f13() {
  ar13.forEach(
    (el, ind) =>
      (document.querySelector('.out-13').textContent += `${ind} ${el} `),
  )
}
...
function f15() {
  ar15.forEach((el) =>
    el > 0
      ? (document.querySelector('.out-15').textContent += el + ' ')
      : false,
  )
}
...
function f16() {
  ar16.forEach((el) => (el % 2 == 0 ? ar16_even.push(el) : ar16_odd.push(el)))
...
function f17() {
  let count = 0
  ar17.forEach((el) => (el > 3 ? count++ : false))
...
function f18() {
  let max = 0
  ar18.forEach((el) => (el > max ? (max = el) : false))
...
function f19() {
  let min = Math.min(...ar19)
  document.querySelector('.out-19').textContent = ar19.indexOf(min)
}
...
function f20() {
  document.querySelector('.out-20').textContent = ar20.reduce(
    (acc, el) => acc + el,
    0,
  )
}
