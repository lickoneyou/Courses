...
const f2 = () => {
  ...
  document.querySelector('.out-2').innerText = a2_res
}
...
const f3 = () => {
  ...
  document.querySelector('.out-3').innerText = a3_res
}
...
const f4 = () => {
  ...
  document.querySelector('.out-4').innerText = a4_res.join(' ')
}
...
const f7 = () => {
  ...
  document.querySelector('.out-7').innerText = a7
}
...
const f9 = () => {
  a9.splice(0, 3, 7, 8)
  document.querySelector('.out-9').innerText = a9.join(' ')
}
