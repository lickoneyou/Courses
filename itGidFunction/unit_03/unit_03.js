...
function t4() {
  ...
  const res = [...radiobuttons].filter((el) => el.checked)
  return res[0].value
}
...
function t5() {
  const n1 = document.querySelector('.s51').value
  const n2 = document.querySelector('.s53').value
  const o = document.querySelector('.s52').value
...
function t8(num, method) {
  return method === 'floor' ? Math.floor(num) : Math.ceil(num)
}
...
function t17() {
  const select = document.querySelector('.s-171').value
  return select
}
...
function t18() {
  const inputValue = document.querySelector('.i-18').value
  return inputValue
}
...
function t19() {
  const inputValue = document.querySelector('.i-19').value
  return inputValue
}
...
function t26() {
  ...
  document.querySelector('.out-26').innerText = inputValue.toLowerCase()
}
