...
function quantitiesByCategories(products) {
  return products.reduce(a =>({...a, 
    'Accessories': products.filter(el => el.category === 'Accessories')[0].quantity + products.filter(el => el.category === 'Accessories')[1].quantity, 
    'Phones': products.filter(el => el.category === 'Phones').reduce((a,b) =>({...a, quantity: b.quantity, }), {}).quantity,
    'Watches': products.filter(el => el.category === 'Watches').reduce((a,b) =>({...a, quantity: b.quantity, }), {}).quantity
    }), 
    {})
}
